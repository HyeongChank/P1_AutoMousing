...
public class MacClick2 {
	...
	public MacClick2(Long id, String x1, String y1, String x2, String y2, String x3, String y3, String x4, String y4,
			...
			String interval4, String interval5, String interval6, String roop, String indb, String checkname) {
		super();
		this.id = id;
		this.x1 = x1;
		this.y1 = y1;
	...
	public String toString() {
		return "MacClick2 [id=" + id + ", x1=" + x1 + ", y1=" + y1 + ", x2=" + x2 + ", y2=" + y2 + ", x3=" + x3
				...
				+ ", interval1=" + interval1 + ", interval2=" + interval2 + ", interval3=" + interval3 + ", interval4="
				+ interval4 + ", interval5=" + interval5 + ", interval6=" + interval6 + ", roop=" + roop + ", indb="
				+ indb + ", checkname=" + checkname + "]";
	}
