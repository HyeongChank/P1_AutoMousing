...
<body>
	...
	<div id= "div2">
		...
		<h5> &nbsp;&nbsp;   - n번-m번 간격(초) : 해당 마우스 클릭 간 대기 시간</h3>
		<h5> &nbsp;&nbsp;   - 1회 순회 후 대기시간 : 최대 5개의 마우스 클릭 후 다음 첫 클릭까지의 대기 시간</h3>
		<h5> &nbsp;&nbsp;   - 반복 시작 : 마우스 좌표 저장 및 대기 시간, 반복 횟수 입력 후 시작하기 버튼 클릭</h3>
		<h5> &nbsp;&nbsp;   - 반복 중지 : 반복 시작 시 작은 창(JFrame)이 뜹니다. 이 창을 클릭한 뒤 스페이스바를 누르면 반복 중지됨</h3>
